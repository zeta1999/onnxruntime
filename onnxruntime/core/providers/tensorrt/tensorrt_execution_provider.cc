...
TensorrtExecutionProvider::TensorrtExecutionProvider(const TensorrtExecutionProviderInfo& info)
  ...
  allocator_ = CreateAllocator(default_memory_info, info.use_cuda_arena, device_id_);
  ...
  InsertAllocator(CreateAllocator(pinned_allocator_info, info.use_cuda_arena, device_id_));
